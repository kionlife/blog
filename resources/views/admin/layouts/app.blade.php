...
<head>
    ...
    <link rel="stylesheet" href="https://flowbite.com/docs/flowbite.css?v=2.1.1a">
    <!-- Fonts -->
...
<body style="height: 600px" class="p-5 bg-white dark:bg-gray-900 antialiased !p-0">
                ...
                <div class="flex items-center">
                    <div class="flex items-center ms-3">
                        ...
                        <div
                            ...
                            id="dropdown-user"
                            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(785px, 54px);"
